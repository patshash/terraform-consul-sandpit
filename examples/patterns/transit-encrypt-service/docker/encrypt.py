...
print("Vault Namespace:", os.getenv("VAULT_NAMESPACE"))
print("Vault Token:", os.getenv("VAULT_TOKEN"))
print("Vault Key Name:", os.getenv("VAULT_KEY_NAME"))
...
def download_file_from_s3(S3_BUCKET_NAME, S3_SOURCE_FILE_KEY, LOCAL_FILE_NAME):
    ...
    s3 = boto3.client('s3')
    try:
        s3.download_file(S3_BUCKET_NAME, S3_SOURCE_FILE_KEY, LOCAL_FILE_NAME)
